...
- `docs/` — 结论文档/档案：`loop_journal.md`（B角代际诊断）/ `factor_roadmap.md`（研发留痕、续做入口）/ `factor_library.md`（Loop 入库因子）/ `loop_archive.csv`（Loop 每代 L2 明细流水，逐代累积）/ `factor_archive.md/.csv`（factor_miner Round1~7 旧归档，已停更）
